...
def main(npy_version,name):
    ...
    urdf_path= '/home/pxing/code/PointNetGPD/PointNetGPD/data_000/ycb-tools/models/ycb/'+name+'/google_512k/nontextured.urdf'   
...
if __name__=='__main__':
    ...
    for i in npy_list_origin:
        name=i.split('.')[0]
        folder='/home/tencent_go/Music/codes/multi_feature_get/using_version/data/npy_select/'+name+'.npy'
