...
name='011_banana'
'''011_banana 003_cracker_box 025_mug'''
...
def scripts():
    #point_file_path='/home/tencent_go/Music/codes/multi_feature_get/dataset_process/npy/'+name+'.npy'
...
sim_params.gravity = gymapi.Vec3(0.0, 0.0, -10)#将重力由-10修改为0
...
model_asset = gym.load_asset(sim, asset_root, '/home/pxing/code/PointNetGPD/PointNetGPD/data_000/ycb-tools/models/ycb/'+name+'/google_512k/nontextured.urdf', asset_options)
