...
name='011_banana'
'''010_potted_meat_can 011_banana 003_cracker_box 013_apple 052_extra_large_clamp'''


def scripts():
    #npy路径
    point_file_path='/home/tencent_go/Music/codes/multi_feature_get/dataset_process/npy/600kb/'+name+'.npy'
...
model_asset = gym.load_asset(sim, asset_root, '/home/pxing/code/PointNetGPD/PointNetGPD/data_running/ycb-tools/models/ycb/'+name+'/google_512k/nontextured.urdf', asset_options)
