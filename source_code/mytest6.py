...
dataset_root='/home/mo/Downloads'
obj_idx = 5
sampled_points, offsets, scores, collision = get_model_grasps('%s/grasp_label/%03d_labels.npz'%(dataset_root, obj_idx))
...
model_asset = gym.load_asset(sim, asset_root, "urdf/ycb/011_banana/011_banana.urdf", asset_options)


# load franka asset
franka_asset_file = "urdf/franka_description/robots/franka_panda_fem_simple_v5_with_arm.urdf"
asset_options = gymapi.AssetOptions()
...
np.save('%s/new_grasp_label/%03d_labels.npz'%(dataset_root, obj_idx))
